...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-KWXC4M8HVK"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-KWXC4M8HVK');
</script>
...
Raw dynamic results are available for more sample on my dedicated GitHub [Reflexions](https://github.com/cedricg-mirror/reflexions)  
